...
class Book (models.Model):
	...
	created_at = models.DateTimeField(auto_now_add=True, null=True, blank=True, verbose_name="Created at")
	updated_at = models.DateTimeField(auto_now=True, verbose_name="Updated at")
	template_name = models.CharField(('Выбор шаблона'),max_length=70,blank=True,)
	uploaded_by = models.ForeignKey(User,verbose_name = 'Автор загрузки',on_delete = models.SET_NULL,null = True,
									blank = True,related_name = 'uploaded_books')
